  ...
  useEffect(() => {
    const loadAdminGames = async () => {
      try {
        ...
        const games = await DataSyncServiceWithEvents.getAllGames();
        setAdminGames(games || []);
      } catch (error) {
      ...
      <div className="flex items-center gap-0.5">
        {[1, 2, 3, 4, 5].map((star) => (
          <Star
            key={star}
            className={`w-3 h-3 ${
              star <= numericDifficulty ? 'fill-current text-gray-900' : 'text-gray-300'
            }`}
          />
        ))}
      </div>
      ...
      <div className={`w-full min-h-screen ${bgClass} flex items-center justify-center p-0 sm:p-2 lg:p-4`}>
          ...
          <div className="flex items-center justify-between gap-2 w-full">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
              ...
              <button
                ...
                className={`flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-2 sm:py-1.5 rounded-lg sm:rounded-full transition-all hover:shadow-sm active:scale-95 border touch-manipulation min-w-[44px] justify-center ${
                  isDark 
              ...
              {activeConfig.showSecuredBadge && (
                <button
                  ...
                  className={`flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3 py-2 sm:py-1.5 rounded-lg sm:rounded-full transition-all hover:shadow-sm active:scale-95 border touch-manipulation min-w-[44px] ${
                    isDark
            ...
            <div className="flex items-center gap-2">
              ...
              <button 
                ...
                className={`transition-colors p-2.5 active:scale-90 touch-manipulation rounded-lg min-w-[44px] min-h-[44px] flex items-center justify-center ${
                  isDark ? 'text-[#737373] hover:text-[#a3a3a3] hover:bg-[#1e1e1e]' : 'text-gray-400 hover:text-gray-600 active:text-gray-700 hover:bg-gray-100'
                }`}
              >
        ...
        {(currentStep !== 'categories' && currentStep !== 'success' && currentStep !== 'failed') && (
          <div className={`${cardBgClass} px-3 sm:px-6 py-3 sm:py-4 border-b ${borderClass} flex-shrink-0 sticky top-[57px] sm:top-[65px] z-10 shadow-sm backdrop-blur-sm ${isDark ? 'bg-[#161616]/95' : 'bg-white/95'}`}>
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={handleBack}
                className={`flex items-center gap-1.5 sm:gap-2 transition-colors active:scale-95 p-2.5 sm:p-2 rounded-lg ${hoverBgClass} touch-manipulation min-w-[44px] min-h-[44px] ${
                  isDark ? 'text-[#a3a3a3] hover:text-[#6366f1]' : 'text-gray-700 hover:text-blue-600 active:text-blue-700 active:bg-gray-100'
                }`}
              >
            ...
            <div className="p-3 sm:p-4 md:p-10 pb-20 sm:pb-10">
              ...
              <div className="flex items-center justify-between mb-4 sm:mb-6 md:mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <button
                  ...
                  className={`p-2.5 sm:p-2 md:p-3 rounded-lg transition-colors active:scale-95 touch-manipulation flex-shrink-0 min-w-[44px] min-h-[44px] flex items-center justify-center ${
                    isDark ? 'hover:bg-[#1e1e1e] active:bg-[#2a2a2a]' : 'hover:bg-gray-100 active:bg-gray-200'
                  }`}
            ...
            <div className="p-4 sm:p-6 md:p-10 pb-20 sm:pb-10">
              ...
              <div className="flex items-center justify-center gap-3 mb-6 lg:hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
                <button
                  ...
                  className={`p-2 sm:p-3 rounded-lg sm:rounded-xl border transition-colors active:scale-95 touch-manipulation shadow-sm ${
                    isDark 
                ...
                <div className={`text-center px-4 py-2 rounded-lg sm:rounded-xl border min-w-[200px] sm:min-w-[240px] ${
                      ...
                      <div className="hidden lg:block animate-in fade-in slide-in-from-left-4 duration-500">
                        <div className="text-center mb-4">
                          <button
                            ...
                            className={`text-sm transition-colors mb-1 active:scale-95 touch-manipulation ${
                              isDark 
                          ...
                          {timeSlots.length > 0 ? (
                            timeSlots.map((slot, idx) => (
                              <button
                                ...
                                className={`w-full flex items-center justify-between px-3 sm:px-4 py-3 sm:py-3.5 border-2 rounded-lg active:scale-[0.98] transition-all shadow-sm hover:shadow touch-manipulation ${
                                  isDark
          ...
          {currentStep === 'plan' && selectedGame && (
            <div className="p-4 sm:p-6 md:p-10 pb-20 sm:pb-10">
              <div className="max-w-3xl">
                {/* Selected Game & Time */}
                <div className={`flex gap-3 sm:gap-4 mb-6 md:mb-8 p-3 sm:p-4 rounded-xl border animate-in fade-in slide-in-from-bottom-4 duration-500 ${
                  isDark ? 'bg-[#1e1e1e] border-[#2a2a2a]' : 'bg-gray-50 border-gray-200'
                }`}>
                ...
                <div className="space-y-3 sm:space-y-4">
                  {ticketTypes.map((ticketType, idx) => (
                    <div
                      key={ticketType.id}
                      className={`flex items-center gap-2 sm:gap-3 md:gap-4 p-3 sm:p-4 md:p-5 border-2 rounded-xl transition-all shadow-sm hover:shadow animate-in fade-in slide-in-from-bottom-4 duration-500 touch-manipulation ${
          ...
          {currentStep === 'cart' && selectedGame && (
            <div className="p-4 sm:p-6 md:p-10 pb-20 sm:pb-10">
              <div className="max-w-4xl">
                ...
                {/* Selected Game & Time */}
                <div className={`flex gap-3 sm:gap-4 mb-6 md:mb-8 p-3 sm:p-4 rounded-xl border animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100 ${
                  isDark ? 'bg-[#1e1e1e] border-[#2a2a2a]' : 'bg-gray-50 border-gray-200'
                }`}>
                            ...
                            <div className="flex-1">
                              ...
                              {idx === 0 && !appliedPromos[item.ticketTypeId] && !showPromoInput[item.ticketTypeId] && (
                                <button 
                                  ...
                                  className={`text-xs md:text-sm hover:underline mt-1 ${
                                    isDark ? 'text-[#6366f1] hover:text-[#818cf8]' : 'text-blue-600'
                                  }`}
                                >
                      ...
                      {showPromoInput[ticketTypeId] && !appliedPromos[ticketTypeId] && (
                        <div className={`px-3 md:px-4 pb-3 md:pb-4 border-t space-y-2 pt-3 ${borderClass}`}>
                          ...
                          {ticketTypeId === 'veteran' && (
                            <div className={`text-xs space-y-1 p-2 rounded border ${
                              isDark 
                ...
                {activeConfig.additionalQuestions && activeConfig.additionalQuestions.length > 0 && (
                  <div className="mb-6 md:mb-8">
                    ...
                    <div className={`flex items-center gap-3 mt-4 p-4 border rounded-lg ${
          ...
          {currentStep === 'failed' && selectedGame && (
            <div className="p-4 md:p-10 min-h-[60vh] flex items-center justify-center">
              <div className="max-w-2xl w-full text-center">
                ...
                <div className={`border rounded-lg p-4 md:p-6 mb-6 md:mb-8 text-left ${
        ...
        <div className={`${cardBgClass} border-t ${borderClass} px-4 sm:px-6 py-4 flex-shrink-0 safe-area-inset-bottom`}>
          <div className={`flex flex-col sm:flex-row items-center justify-between text-xs sm:text-sm gap-2 sm:gap-3 ${textMutedClass}`}>
            <button className={`flex items-center gap-2 transition-colors active:scale-95 touch-manipulation ${
          ...
          {currentStep === 'categories' && (
            <div className={`mt-2 text-xs text-center sm:text-left ${isDark ? 'text-[#737373]' : 'text-gray-500'}`}>
              ...
              <button className={`underline touch-manipulation ${
                isDark ? 'hover:text-[#a3a3a3] active:text-white' : 'hover:text-gray-700 active:text-gray-900'
